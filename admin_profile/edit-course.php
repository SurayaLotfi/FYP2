...
if(isset($_GET['course_id'])){
    ...
    $sql = "SELECT * FROM class WHERE id=$course_id";
							...
							<form id="uploadForm" class="edit-profile m-b30" action="./phpfiles/update.php" method="post" enctype="multipart/form-data">
								<div class="row">
									...
									<!-- <div class="form-group col-6">
										...
										<div>
										<input class="form-control" type="text" id="class_code" name="class_code" value="<?php echo $class_code?>">
										</div>
									</div> -->
									...
									<!-- <div class="form-group col-6">
										...
										<div>
										<input class="form-control" type="date" id="due" name="dateDue" value="<?php echo $due?>">
										</div>
									</div> -->
									<div class="form-group col-6">
									...
									<div class="form-group col-6">
										...
										<select class="form-control" id="folder-select" name="content" value="<?php echo $content?>">
											<?php
											...
											if ($files) {
												...
												foreach ($files as $file) {
													if ($file != "." && $file != "..") {
                                                        ?> <option value = "<?php echo $file ?>" <?php if ($content == $file) echo 'selected'?>> <?php echo $file?>  </option><?php
									...
									<?php }else{?>
										<div class="form-group col-6">
											<label class="col-form-label" for="folder-select">Knowledge</label>
											<div class="d-flex">
