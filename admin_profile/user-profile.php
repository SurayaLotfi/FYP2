				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" action="phpfiles/add-user.php" method="POST">
								<div class="">
									...
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input class="form-control" name="full_name" type="text" placeholder="Enter full name">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input class="form-control" name="password" type="text" placeholder="Enter temporary password">
										</div>
									</div>
								<div class="">
									<div class="">
										<div class="row">
											...
											<div class="col-sm-7">
												...
												<button  type="submit" class="btn btn-info btn-rounded  "  name="submit" type="submit">Add User</button> 
											</div>
										</div>
									</div>
								</div>
