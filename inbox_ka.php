        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/malaysia-airlines-bg.jpeg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Inbox ( <?php echo $total_inbox ?> )</h1>
					 ...
					 <div class="row">
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							...
							<div class="widget widget_archive">
                                <h5 class="widget-title style-1">FILTER</h5>
                                <ul>
									...
									<li class="select_format"><a href="fetch_courses.php?contents=KS">Accepted Knowledge Shared</a></li>
									<li class="select_format"><a href="fetch_courses.php?contents=KS">Declined Knowledge Shared </a></li>
						...
						$total_pages = ceil($total_records/$limit);
							...
							?> 
                            <h4> You have <?php echo mysqli_num_rows($result) ?> New Accepted knowledge.<br></h4>
