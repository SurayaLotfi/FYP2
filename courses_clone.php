        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/malaysia-airlines-bg.jpeg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Classess</h1>
					 ...
					 <div class="row">
                                    ...
                                    <div class="widget-post clearfix">
                                        ...
                                        <div class="ttr-post-info">
                                            ...
                                            <div class="ttr-post-meta">
                                                <ul>
                                                    <li class="price">
														<h5 class="free"><?php echo $row['class_code'] ?></h5>
													</li>
                        ...
                        <div class="cours-bx" >
							<div class="action-box">
								<img src="" alt="">
									<a href="courses-details.php?course_id=<?php echo $row['id'] ?>" class="btn">Read More</a>
								</div>
									...
									<div class="cours-more-info">
											<div class="review">
												...
												<br>
												<span>Due: <?php echo $remainingDays_due?> days</span>
												<?php }else{?>
												<span style="color: red;">Validity: 0 days</span>
												<br>
												<span style="color: red;">Due: <?php echo $remainingDays_due?> days</span>
												<?php
												} ?>
												<br>
											...
											<div class="price">
												...
												<h5 style="font-size: 12px;"> <?php
													if ($row['content_record_status'] === null) {
														echo 'Not yet started';
													} else {
														echo $row['content_record_status'];
													}
													?>
												</h5>
											</div>
								...
								<img src="" alt="">
									...
									<div class="cours-more-info">
											...
											<div class="price">
												...
												<h7 style="font-size: 12px;">Status<h7>
												<h5 style="font-size: 12px;"> <?php
                                                    $query2 = "SELECT * FROM content_record
                                                             WHERE username = '$username'
                                                             AND status = 'In Progress'";
                                                    $result2 = mysqli_query($db, $query2);

                                                    //in fetch courses, buat query dia mcm ni, then capture the variable. 

                                                    if(mysqli_num_rows($result2)>0){ //if ada username dia daam record, meaning dia dah in prgoress
														echo 'In progress';
													} else { //if not, dia tak start lagi
														echo 'Not yet started';
													}
